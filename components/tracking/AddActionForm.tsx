    ...
    <form action={action} className="mt-8 p-8 bg-bg-card border border-border-subtle rounded-[2.5rem] space-y-6 shadow-2xl relative overflow-hidden group">
      ...
      <div className="flex justify-end gap-4 pt-2 relative z-10">
        ...
        <button
          type="submit"
          disabled={isPending}
          className="h-12 px-10 bg-primary hover:bg-primary-hover text-white rounded-xl text-xs font-bold uppercase transition-all disabled:opacity-50 shadow-lg shadow-primary/20 active:scale-[0.98] flex items-center gap-2"
        >
          {isPending && (
